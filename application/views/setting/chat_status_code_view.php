    ...
    observable: {
    	...
    	saveEdit: function(e) {
            ...
            .then((sure) => {
                if (sure) {
                    $.ajax({
                        url: `${ENV.vApi}chatstatuscode/update/${id}`,
                        type: "PUT",
...
<div id="page-content">
    ...
    <div class="container-fluid">
        <h4 class="fieldset-legend" style="margin: 10px 0 30px"><span style="font-weight: 500">CHAT STATUS</span></h4>
        <div class="row">
    ...
    <script id="template" type="text/x-kendo-template">
        <div class="view-container" data-id="#: data.id #"> 
            ...
            <div class="edit-container" data-bind="visible: visibleEdit">
            	...
            	<a href="javascript:void(0)" class="k-button" data-bind="click: saveEdit">@Sav@</a>&nbsp;

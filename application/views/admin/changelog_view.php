        ...
        observable: {
            ...
            changeVisibleCode: function(e) {
                if(e.currentTarget.checked) {
                    ...
                    .then((value) => {
                      if (value == ENV.agentname) {
                        this.set("view.visibleCode", true);
                      } else {
                        swal("Your password is incorrect!!");
                      }
                    });
                } else {
                    this.set("view.visibleCode", false);
                }
            },
            save: function() {
            	var treeview = $("#treeview").data("kendoTreeView"),
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                        	...
                        	<span data-bind="visible: selectedItem.exists"><i class="fa fa-check text-success"></i></span>

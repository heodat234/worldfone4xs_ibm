<div class="input-group-btn column-widget">
	...
	<a role="button" class="btn btn-alt btn-sm btn-primary" data-field="disbursed_date" onclick="customFilter(this, Table.dataSource)"><i class="fa fa-filter"></i> <b>@Custom Filter@</b></a>
</div>
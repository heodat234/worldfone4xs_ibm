...
<script>
    var model = kendo.observable({
        historyData: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: ENV.vApi + "disbursement/importHistoryRead",
                },
            ...
            filter: [{field: 'collection', operator: 'eq', value: "Disbursement"}]
        }),
...
var disbursementHistory = function() {
    return {
        model: model,
        init: function () {
            kendo.bind("#disbursement-history", kendo.observable(this.model));
            /*
             * Right Click Menu
             */
...
function cancelUpload(id) {
    $.ajax({
        url: ENV.vApi + `disbursement/update_import_log/${id}`,

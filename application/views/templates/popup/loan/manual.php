<div id="all-popup">
    <div id="popup-window" data-role="window"
                     data-title="POPUP LOAN (Click to call)"
                     data-width="1200"
...
window.popupObservable.assign({
    ...
    save: function() {
        ...
        .then((surecheck) => {console.log('sure2',surecheck)
            ...
            $.ajax({
                url: ENV.vApi + "diallist_detail/update_cdr/" + (data.id || ""),
                type: "PUT",
                contentType: "application/json; charset=utf-8",
                data: kendo.stringify({calluuid: window.popupObservable.dataCall.calluuid ? window.popupObservable.dataCall.calluuid : ''}),
                success: (response) => {

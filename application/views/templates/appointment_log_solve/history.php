...
<!--    <div class="col-sm-9 filter-mvvm" style="display: none; margin: 10px 0"></div>-->
    ...
    <div id="history-action-menu" class="action-menu">
        <ul>
            ...
            <li class="devide"></li>
            <a href="javascript:void(0)" data-type="import" onclick="divideList(this)"><li><i class="fa fa-exclamation-circle text-info"></i><span>Divide List</span></li></a>
...
<script>
    var model = kendo.observable({
        historyData: new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: ENV.vApi + "appointment/importHistoryRead",
                },
...
var appointmentHistory = function() {
    return {
        model: model,
        init: function () {
            kendo.bind("#appointment-history", kendo.observable(this.model));
            /*
             * Right Click Menu
             */

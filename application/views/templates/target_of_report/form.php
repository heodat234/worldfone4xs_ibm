                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input data-role="dropdownlist" name="debt_type" data-value-primitive="true"
                            data-bind="value: item.debt_type, source: debtTypeOptions , enabled: item.active, events:{ select: debtTypeSelect}"
                            style="width: 100%">
                    </div>
                    <div class="col-md-3">
                        <label>Group:</label>
                        <input data-role="dropdownlist" name="debt_group" data-value-primitive="true"
                            data-bind="value: item.debt_group, source: debtGroupOptions , enabled: item.group_active, events:{ select: debtGroupSelect}"
                            style="width: 100%">
                    </div>
                    ...
                    <button id="trigger_update_item_name"
                        data-bind="visible:false, events:{click: updateItemName}">.</button>
                </div>
            </div>
            <div class="form-group">

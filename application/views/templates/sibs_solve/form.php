	...
	<div class="row">
        <div id="main-form" style="width: 100%">
            <div class="form-group">
                <label>@Code@</label>
                <input class="k-textbox" style="width: 100%" data-bind="value: item.dealer_code">
            </div>
            <div class="form-group">
                <label>@Name@</label>
            ...
            <div class="form-group">
                <label>@Address@</label>
                <input class="k-textbox" style="width: 100%" data-bind="value: item.address">
            </div>
            <div class="form-group">
                <label>@District@</label>
                <input class="k-textbox" style="width: 100%" data-bind="value: item.district">
            </div>
            <div class="form-group">
                <label>@Province@</label>
                <input class="k-textbox" style="width: 100%" data-bind="value: item.province">
            </div>
            <div class="form-group">
                <label>@Phone@</label>

<div data-role="splitter"
    ...
    <div class="col-sm-9" id="left-col">
        <h4 class="fieldset-legend" style="margin: 0 0 20px"><span style="font-weight: 500;  line-height: 1">@STATISTIC CALL OUT TODAY@</span></h4>
    ...
    <div class="col-sm-3" style="height: 80vh; overflow-y: auto; overflow-x: hidden; padding: 0;" id="right-col">
        <div style="padding: 5px">
            <h4 class="text-center" style="margin-top: 7px; margin-bottom: 12px">@ABANDONED CALL TODAY@</h4>
        	<table class="customertable">
        		<thead>
	                <tr>
	                	<th>@Extension@ <i class="fa fa-arrow-circle-o-right"></i></th>
	                    <th>@Phone@</th>
	                    <th>@Wait Duration@</th>
	                </tr>
	            </thead>
	            <tbody data-template="abandoned-template"
...
<script id="abandoned-template" type="text/x-kendo-template">
	<tr>
		<td data-bind="text: userextension"></td>

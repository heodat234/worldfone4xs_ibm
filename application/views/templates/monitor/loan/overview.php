            ...
            <table class="metrotable">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 100px">@Agent name@</th>
...
<script id="body-template" type="text/x-kendo-template">
    ...
    <tr class="# switch (data.activeStatus) { 
        ...
        <td style="text-align: center">
            <span data-bind="attr: {data-total-time: s3}" #if(activeStatus == "s3"){#class="label label label-primary time-interval"#}#>
            #if(data.s3){##: kendo.toString(new Date(d.getTime() + data.s3 * 1000), 'H:mm:ss') ##}#
            </span>
        </td>
        <td>
        ...
        <td style="width: 150px">
            # if(data.currentCall) { #
                <div class="btn-group btn-group-xs">
                    ...
                    <a href="javascript:void(0)" data-role="tooltip" title="@Three hand conversation@" onclick="spyAction('#: data.extension #', 'barge')"><img src="public/stel/img/icon/whisper-enable.png"/></a>
                    <a href="javascript:void(0)" onclick="hangupAction('#: data.currentCall.calluuid #')"><img src="public/stel/img/icon/hangup-enable.png"/></a>
                </div>
            # } else { #
                <div class="btn-group btn-group-xs">
        ...
        <div class="widget-advanced">
            ...
            <div class="widget-main">
                ...
                <div class="widget-options">
                    <div class="btn-group btn-group-xs">
                        <a href="javascript:void(0)" data-role="tooltip" title="@Three hand conversation@" onclick="spyAction('#: data.extension #', 'barge')"><img src="public/stel/img/icon/whisper-enable.png"/></a>
                        <a href="javascript:void(0)" data-role="tooltip" title="@Hangup@" onclick="hangupAction('#: data.currentCall.calluuid #')"><img src="public/stel/img/icon/hangup-enable.png"/></a>
                    </div>
                </div>
                # } else { #
                <div class="widget-options-left">
        ...
        init: function() {
            ...
            var observable = {
                ...
                groupOption: new kendo.data.DataSource({
                    ...
                    transport: {
                        read: `${ENV.vApi}monitor/getGroups`,
                        parameterMap: parameterMap
                    },
                    schema: {
                        data: "data"

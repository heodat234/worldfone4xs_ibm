    ...
    <div align="center" style="align-items: center">
        ...
        <div style="clear: both;">
            ...
            <div id="example" class="absConf" style="margin: 0 auto">
                ...
                <div id="grid-date-availability" ></div>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $("#grid-date-availability").kendoGrid({
                        toolbar: ["excel"],
                        excel: {
                            allPages: true,
                            fileName: "Date summary.xlsx"
                        },
                        pdf: {
                            allPages: true,
                            fileName: "Date summary.pdf"
                        },
                        dataSource: {
                            transport: {
                                read: {
                                    url: ENV.reportApi + "chat/agent_chat_summary/dateagentsum",
                                    type: "POST",
                                    dataType: 'json',

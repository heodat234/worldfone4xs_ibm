...
<script>
    ...
    window.onload = function() {
        ...
        router.route("/", async function() {
            ...
            var HTML = await $.get(`${Config.templateApi}loan_group_report/overview`);
        ...
        router.route("/import", async function() {
            var HTML = await $.get(`${Config.templateApi}loan_group_report/import`);
            var kendoView = new kendo.View(HTML);
            layout.showIn("#bottom-row", kendoView);
        });

        router.route("/history", async function() {
            var HTML = await $.get(`${Config.templateApi}loan_group_report/history`);
            var kendoView = new kendo.View(HTML);
            layout.showIn("#bottom-row", kendoView);
        });
...
<script id="layout" type="text/x-kendo-template">
    <ul class="breadcrumb breadcrumb-top">
        <li>@Report@</li>
        <li>Card Loan Group Daily Report</li>

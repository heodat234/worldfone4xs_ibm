...
<script>
    ...
    window.onload = function() {
        ...
        router.route("/", async function() {
            ...
            var HTML = await $.get(`${Config.templateApi}daily_payment_report/overview`);
        ...
        router.route("/import", async function() {
            var HTML = await $.get(`${Config.templateApi}daily_payment_report/import`);
            var kendoView = new kendo.View(HTML);
            layout.showIn("#bottom-row", kendoView);
        });

        router.route("/history", async function() {
            var HTML = await $.get(`${Config.templateApi}daily_payment_report/history`);
            var kendoView = new kendo.View(HTML);
            layout.showIn("#bottom-row", kendoView);
        });

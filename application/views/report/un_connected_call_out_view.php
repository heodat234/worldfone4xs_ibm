<div id="page-content">
	        	...
	        	<div data-role="grid" id="grid"
                        ...
                        data-columns="[
                                ...
                                },
				            	{
				            	    field: 'time_call',
				            	    title: '@Time@',
				            	    template: data => gridDate(data.starttime, 'H:mm')
                                },
				            	{
	...
	<script>
		    ...
		    var observable = window.observable = kendo.observable({
		        ...
		        asyncSearch: async function() {
	                ...
	                if(extensions.length > 0) {
                        filters.push({field: "userextension", operator: "in", value: extensions})
                    }
		        ...
		        dataReport: new kendo.data.DataSource({
                    ...
                    pageSize: 15,
		        	transport: {
		        		read: ENV.reportApi + "unconnectedcallout/read",
		        		parameterMap: parameterMap
		        	},
		        	// aggregate: [
        ...
        function exportGridExcel() {
			...
			$.ajax({
                url: ENV.reportApi + "unconnectedcallout/exportExcel",

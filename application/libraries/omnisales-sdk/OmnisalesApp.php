...
class OmnisalesApp{
    ...
    public function __construct($id, $secret){
    	if (!is_string($id)
          ...
          && !is_int($id)) {
            throw new OmnisalesSDKException('The "app_id" must be formatted as a string since many app ID\'s are greater than PHP_INT_MAX on some systems.');
        }
    ...
    /**
     * Serializes the OmnisalesApp entity as a string.
     *
     * @return string
     */
    ...
    /**
     * Unserializes a string as a OmnisalesApp entity.
     *

...
namespace Omnisales\FileUpload;
...
class OmnisalesFile
{
    ...
    /**
     * Creates a new OmnisalesFile entity.
     *
    ...
    public function open()
    {
        if (!$this->isRemoteFile($this->path) && !is_readable($this->path)) {
            throw new OmnisalesSDKException('Failed to create OmnisalesFile entity. Unable to read resource: ' . $this->path . '.');
        }

        $this->stream = fopen($this->path, 'r');

        if (!$this->stream) {
            throw new OmnisalesSDKException('Failed to create OmnisalesFile entity. Unable to open resource: ' . $this->path . '.');
        }
    }

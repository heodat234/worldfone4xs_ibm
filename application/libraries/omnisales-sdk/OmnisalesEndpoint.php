...
class OmnisalesEndpoint {
     ...
     * @const 
     */
    const API_GRAPH_MESSAGE = 'me/sendmessage/text';

    /**
     * @const 
     */
    const API_GRAPH_IMAGE = 'me/sendmessage/image';

    /**
     * @const 
     */
    const API_GRAPH_CREATE_COMMENT = 'me/comment/create';

    /**
     * @const 
     */
    const API_GRAPH_REMOVE_COMMENT = 'me/comment/remove';

    /**
     * @const 
     */
    const API_GRAPH_HIDE_COMMENT = 'me/comment/hide';

    /**
     * @const 
     */
    const API_GRAPH_LIKE_COMMENT = 'me/comment/likes';

    /**
     * @const 
     */
    const API_GRAPH_PRIVATE_REPLIES_COMMENT = 'me/comment/private_replies';
     ...
     * @const 
     */
    const API_GET_PROFILE = 'app/getprofile';

    /**
     * @const 
     */
    const API_GET_PAGES = 'app/getpages';

    /**
     * @const 
     */
    const API_GET_POSTS = 'app/getposts';

    /**
     * @const 
     */
    const API_GET_POST = 'app/getpost';

    /**
     * @const 
     */
    const API_UPLOAD_PHOTO = 'app/upload/image';

    /**
     * @const 
     */
    const API_UPLOAD_GIF = 'app/upload/gif';

    /**
     * @const 
     */
    const API_EVENT_UPDATE_LIVECHAT_REMOTE = 'livechat_remote/event_update_livechat_remote';

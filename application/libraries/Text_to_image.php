...
class Text_to_image {
     ...
     */
    function createImage($text, $fontSize = 14, $imgWidth = 0, $imgHeight = 0, $angle = 0){

        //text font path
        $font = FCPATH . 'public/stel/css/fonts/arial.ttf';
        
        $imgHeight = $imgHeight ? $imgHeight : $fontSize * 6 / 4;
        $imgWidth = $imgWidth ? $imgWidth : strlen($text) * ($fontSize - 5) + 20;
        //create the image

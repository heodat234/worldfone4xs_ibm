...
Class Report_off_system_date extends WFF_Controller {

	private $collection = "Report_off_sys";
	...
	function create()
	{
		...
		$offDate = explode("T", $data["off_date"]);
		$data['off_date'] = $offDate[0];
		$data["off_date"] = strtotime($data['off_date']);

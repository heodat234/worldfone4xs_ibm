...
Class Daily_payment_report extends WFF_Controller {
    ...
    function saveExport()
    {
        ...
        foreach ($data as &$value) {
            ...
            $value['product'] = $product['due_date'];
            ...
            unset($value['branch'],$value['currency'],$value['code'],$value['id']);

            $this->crud->create($this->collection, $value);
        }
        // print_r($data);
        // $this->crud->create($this->collection, $data);
    }
}
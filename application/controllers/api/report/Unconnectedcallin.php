...
Class Unconnectedcallin extends WFF_Controller {
    ...
    function exportExcel() {
        ...
        if(!empty($dataExportTemp['data'])) {
            ...
            foreach ($dataExport as $dataKey => &$dataValue) {
                ...
                if(!empty($dataValue['glide_extension'])) {
                    $dataValue['transfer_to'] = implode(", ",$dataValue['glide_extension']);
                }
                else {
                    $dataValue['transfer_to'] = $dataValue['queue'];
                }
            }
        }
        $filename = "Unconnected_call_in.xlsx";

...
router.route("/", async function() {
    var HTML = await $.get(`${Config.templateApi}monitor/telesale/overview`);
    var model = {
...
router.route("/callin", async function(id) {
    var HTML = await $.get(`${Config.templateApi}monitor/telesale/callin`);
    var model = {
...
router.route("/callout", async function(id) {
    var HTML = await $.get(`${Config.templateApi}monitor/telesale/callout`);
    var model = {
        dataSource: new kendo.data.DataSource({
            serverAggregates: true,
            aggregate: [],
...
router.route("/activity", async function(id) {
    var HTML = await $.get(`${Config.templateApi}monitor/telesale/activity`);
    var kendoView = new kendo.View(HTML);
    layout.showIn("#bottom-row", kendoView);
});

router.route("/performance", async function(id) {
    var HTML = await $.get(`${Config.templateApi}monitor/telesale/performance`);
    var kendoView = new kendo.View(HTML);
    layout.showIn("#bottom-row", kendoView);
});

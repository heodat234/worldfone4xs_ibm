...
*/
! function(t, define) {
    define("mychat/view.min", ["kendo.core.min", "kendo.draganddrop.min"], t)
}(function() {
    return function(t, e) {
        var s, n, i, o, a = window.kendo,
            r = a.ui.Widget,
            l = t.extend,
            c = t.proxy,
            d = ".",
            h = " ",
            u = ".kendoChat",
            p = a.template('<div #:text# class="#=styles.messageGroup# #= url ? "" : styles.noAvatar #"><p class="#=styles.author#">#:text#</p># if (url) { #<img src="#=url#" alt="#:text#" class="#=styles.avatar#"># } #</div>'),
            g = a.template('<div me class="#=styles.messageGroup# #=styles.self# #= url ? "" : styles.noAvatar #"># if (url) { #<img src="#=url#" alt="#:text#" class="#=styles.avatar#"># } #</div>'),
            m = a.template('<div class="#=styles.message#" # if (typeof uid !== "undefined") { # id="#: uid #" # } #><time class="#=styles.messageTime#">#= kendo.toString(kendo.parseDate(timestamp), "dd/MM/yy HH:mm:ss") #</time><div class="#=styles.status#">#=status#</div><div class="#=styles.bubble#">#:text#</div></div>'),
            f = a.template('<div class="#=styles.messageListContent# #=styles.typingIndicatorBubble#"><p class="#=styles.author#">#:text#</p><div class="#=styles.message#"><div class="#=styles.bubble#"><div class="#=styles.typingIndicator#"><span></span><span></span><span></span></div></div></div></div>'),
            b = a.template('<div class="#=styles.suggestedActions#"># for (var i = 0; i < suggestedActions.length; i++) { #<span class="#=styles.suggestedAction#" data-value="#:suggestedActions[i].value#">#:suggestedActions[i].title#</span># } #</div>'),
            ...
            w = a.template('<div class="#=styles.message#" # if (typeof uid !== "undefined") { # id="#: uid #" # } #><time class="#=styles.messageTime#">#= kendo.toString(kendo.parseDate(timestamp), "dd/MM/yy HH:mm:ss") #</time><div class="#=styles.status#">#=status#</div><div class="#=styles.bubble#">#if(typeof url != "undefined"){#<a data-toggle="lightbox-image" target="_blank" href="#:url#" onmouseover="zoomImgChat(this)"><img src="#:url#" class="#=styles.messageImg#"></a>#}#</div></div>'),
            file = a.template('<div class="#=styles.message#" # if (typeof uid !== "undefined") { # id="#: uid #" # } #><time class="#=styles.messageTime#">#= kendo.toString(kendo.parseDate(timestamp), "dd/MM/yy HH:mm:ss") #</time><div class="#=styles.status#">#=status#</div><div class="#=styles.bubble#">#if(typeof url != "undefined"){#<i class="fa fa-file-o"></i> <a href="#:url#" download target="_blank"><b>#if(text){##: text ##}else{##: url ##}#</b></a>#}#</div></div>');
        a.chat = {
            Templates: {},
            Components: {}
        }, a.chat.registerTemplate = function(t, e) {
            a.chat.Templates[t] = a.template(e)
        }, a.chat.getTemplate = function(t) {
            return a.chat.Templates[t] || m
        }, a.chat.registerTemplate("file", file), a.chat.registerTemplate("img", w), a.chat.registerTemplate("text", m), a.chat.registerTemplate("message", m), a.chat.registerTemplate("typing", f), a.chat.registerTemplate("suggestedAction", b), a.chat.registerTemplate("heroCard", y), a.chat.registerTemplate("application/vnd.microsoft.card.hero", y), a.chat.registerComponent = function(t, e) {
            a.chat.Components[t] = e
        }, a.chat.getComponent = function(t) {
            return a.chat.Components[t] || null
        }, s = a.chat.Component = a.Class.extend({
            init: function(e, s) {
                this.element = t("<div></div>"), this.options = e, this.view = s
            },
            destroy: function() {
                a.destroy(this.element)
            }
        }), n = s.extend({
            init: function(t, e) {
                s.fn.init.call(this, t, e), this.element.kendoCalendar({
                    change: function() {
                        e.trigger("suggestedAction", {
                            text: a.toString(this.value(), "d"),
                            type: "message"
                        })
                    }
                })
            ...
            destroy: function() {}
        }), a.chat.registerComponent("calendar", n), i = {
            ...
            typingIndicator: "k-typing-indicator animation-pulse",
            ...
            status: "k-message-status",
            messageImg: "k-message-img",
        }, o = a.chat.ChatView = r.extend({
            init: function(t, e) {
                r.fn.init.call(this, t, e), this._list(), this._lastSender = null, this.typingParticipants = [], this._attachEvents(), this._scrollable()
            },
            events: [],
            options: {
                messages: {
            ...
            destroy: function() {
                r.fn.destroy.call(this), this._scrollDraggable && this._scrollDraggable.destroy(), this.element.empty(), this.element.off(u), this.list = null, this._lastSender = null
            },
            _list: function() {
                var e = o.styles;
            ...
            _attachEvents: function() {
                var t = o.styles;
                this.element.on("click" + u, c(this._listClick, this)).on("click" + u, d + t.message, c(this._messageClick, this)).on("click" + u, d + t.suggestedAction, c(this._suggestedActionClick, this)).on("click" + u, d + t.cardAction + h + d + t.button, c(this._cardActionClick, this))
            },
            _scrollable: function() {
                var t = o.styles;
                this.element.on("click" + u, d + t.cardDeckScrollWrap + h + d + t.button, c(this._scrollButtonClick, this))
            },
            _scrollButtonClick: function(e) {
                var s = o.styles,
                    n = t(e.currentTarget),
                    i = 0 !== n.find(d + s.scrollButtonIconLeft).length,
                    a = n.siblings(d + s.cardDeck),
                    r = a.find(d + s.card).last(),
                    l = r.outerWidth(!0);
                a.scrollLeft(i ? a.scrollLeft() - l : a.scrollLeft() + l)
            },
            getTemplate: function(t) {
                return a.chat.getTemplate(t)
            },
            getComponent: function(t) {
                return a.chat.getComponent(t)
            },
            ...
            preRenderMessage: function(t, e) {
                t.timestamp || (t.timestamp = new Date), t.text || (t.text = "");
                var s = this._renderTemplate(t.type, t);
                this._preRenderBubble(t.type, s, e), "typing" == t.type ? this.typingParticipants.length > 0 && this._removeTypingParticipant(e) : this._firstSender = e.id
            },
            _preRenderBubble: function(t, e, s) {
                var n = this._getPreMessageGroup(s, t);
                this._prependToGroup(n, e, t)
            },
            _getPreMessageGroup: function(e, s) {
                var n, i = o.styles,
                    a = this._getMessageGroupTemplate(e, s),
                    r = "typing" == s ? this.element : this.list;
                return e.id === this._firstSender && null !== this._firstSender && "typing" !== s && (n = this.list.find(d + i.messageGroup).first(), n.length) ? n : t(a({
                    text: e.name,
                    url: e.iconUrl,
                    styles: i
                })).prependTo(r)
            },
            _prependToGroup: function(t, e, s) {
                var n = o.styles,
                    i = t.find(d + n.message),
                    a = i.length,
                    r = this.element.find(d + n.typingIndicator);
                r.length && "typing" == s || (e.addClass(0 === a ? n.only : n.first), i.filter(d + n.only).removeClass(n.only).addClass(n.last), i.filter(d + n.first).removeClass(n.first).addClass(n.middle), t.prepend(e))
            },
            preRenderSuggestedActions: function(t) {
            ...
            renderAttachments: function(t) {
                var e, s, n = this._renderAttachmentWrapper(t.attachmentLayout),
                    i = "carousel" === t.attachmentLayout ? n.find(d + o.styles.cardDeck) : n,
                    a = t.attachments;
                if (a.length) {
                    for (e = 0; e < a.length; e++) s = this._renderTemplate(a[e].contentType, a[e].content), i.append(s);
                    this._removeSuggestedActions(), this._removeTypingIndicator(), this.list.append(n), this._lastSender = null
                }
            },
            renderComponent: function(t) {
                var e = this.getComponent(t),
                    s = new e({}, this);
                this.list.append(s.element), this._scrollToBottom()
            },
            _renderAttachmentWrapper: function(e) {
                var s, n, i = o.styles,
                    a = t("<div>");
                return "carousel" === e ? (a.addClass(i.cardDeckScrollWrap), s = this._renderScrollButton(i.scrollButtonIconLeft), a.append(s), a.append(t("<div>").addClass(i.cardDeck)), n = this._renderScrollButton(i.scrollButtonIconRight), a.append(n)) : a.addClass(i.cardList), a
            },
            ...
            _removeSuggestedActions: function() {
                this.list.find(d + o.styles.suggestedActions).remove()
            },
            _listClick: function(e) {
                var s = o.styles,
                    n = t(e.target);
                n.hasClass(s.message) || n.parents(d + s.message).length || this._clearSelection()
            },
            _messageClick: function(e) {
                this._clearSelection(), t(e.currentTarget).addClass(o.styles.selected)
            },
            ...
            _renderTemplate: function(e, s) {
                var n, i, a, r, c = this.getComponent(e);
                return c ? (i = new c(s, this), n = i.element) : (a = this.getTemplate(e), r = l(!0, {}, s, {
                    styles: o.styles
                }), n = t(a(r))), n
            },
            _getMessageGroup: function(e, s) {
                var n, i = o.styles,
                    a = this._getMessageGroupTemplate(e, s),
                    r = "typing" == s ? this.element : this.list;
                return e.id === this._lastSender && null !== this._lastSender && "typing" !== s && (n = this.list.find(d + i.messageGroup).last(), n.length) ? n : t(a({
                    text: e.name,
                    url: e.iconUrl,
                    styles: i
                })).appendTo(r)
            ...
            _getMessageGroupTemplate: function(t, e) {
                var s = t.id === this.options.user.id,
                    n = s ? g : p;
                return "typing" == e && (n = f), n
            },
            _appendToGroup: function(t, e, s) {
                var n = o.styles,
                    ...
                    a = i.length,
                    r = this.element.find(d + n.typingIndicator);
                r.length && "typing" == s || (e.addClass(0 === a ? n.only : n.last), i.filter(d + n.only).removeClass(n.only).addClass(n.first), i.filter(d + n.last).removeClass(n.last).addClass(n.middle), t.append(e))
            },
            _renderTypingIndicator: function(e) {
                var s, n, o = this.element.find(d + i.typingIndicatorBubble);
                this._addTypingParticipant(e), o.length ? (n = this._composeTypingParticipantsText(this.typingParticipants), s = o.find(d + i.author).first(), s.text(n)) : t(f({
            ...
            _addTypingParticipant: function(t) {
                var e, s = !1;
                for (e = 0; e < this.typingParticipants.length; e += 1)
                    if (this.typingParticipants[e].id == t.id) {
                        s = !0;
                        break
                    } s || this.typingParticipants.push(t)
            },
            _removeTypingParticipant: function(t) {
                var e, s, n, o = this.element.find(d + i.typingIndicatorBubble);
                if (o.length) {
                    for (n = 0; n < this.typingParticipants.length; n += 1) this.typingParticipants[n].id == t.id && this.typingParticipants.splice(n, 1);
                    s = this._composeTypingParticipantsText(this.typingParticipants), "" === s ? o.remove() : (e = o.find(d + i.author).first(), e.text(s))
                }
            },
            ...
            _removeTypingIndicator: function() {
                var t = this.element.find(d + i.typingIndicatorBubble);
                t.length && (this.typingParticipants = [], t.remove())
            },
            _clearSelection: function() {
                var t = o.styles.selected;
                this.element.find(d + t).removeClass(t)
            },
...
}, "function" == typeof define && define.amd ? define : function(t, e, s) {
    (s || e)()
}),
function(t, define) {
    define("mychat/messageBox.min", ["kendo.core.min"], t)
}(function() {
    return function(t, e) {
        var s = window.kendo,
            n = s.ui.Widget,
            ...
            u = s.chat.ChatMessageBox = n.extend({
                ...
                _sendMessage: function() {
                    ...
                    e.length && (this._triggerTyping(!1), t = {
                        text: e
                    }, this.trigger("sendMessage", t), this.input.val(""))
                },
...
function(t, define) {
    define("mychat/toolbar.min", ["kendo.core.min"], t)
}(function() {
    return function(t, e) {
        var s = window.kendo,
            n = s.ui.Widget,
            ...
            m = s.chat.ChatToolBar = n.extend({
                init: function(t, e) {
                    ...
                    e = i({}, e, {
                        name: "ChatToolbar"
                    }), s = e.toolbar, a = s.buttons && s.buttons.length, n.fn.init.call(this, t, e), a && this._createButtonList(), a && s.scrollable && this.buttonsWidth() > this.element.width() && this._initScrolling(), this._setupAnimation(), s.toggleable && this.toggle(!0), this.element.on("click" + r, o(this._onClick, this))
                },
                events: ["click"],
                destroy: function() {
                ...
                _createButtonList: function() {
                    var e, s, n = this,
                        i = m.styles,
                        o = n.options.toolbar.buttons,
                        a = t("<div class='" + i.buttonList + "'></div>");
                    for (e = 0; e < o.length; e++) s = n._createButton(o[e]), a.append(s);
                    a.appendTo(this.element), this.buttonList = a
                },
                ...
                _scroll: function(t) {
                    var e = this,
                        ...
                        i = t === c ? s * -1 : s,
                        o = this.currentScrollLeft(),
                        a = o + i;
                    a = Math.min(Math.max(a, 0), n), t !== c && t !== d || (e.buttonList.scrollLeft(a), e._refreshScrollButtons(a))
                },
...
function(t, define) {
    define("kendo.mychat.min", ["chat/view.min", "chat/messageBox.min", "chat/toolbar.min"], t)
}(function() {
    return function(t, e) {
        var s = window.kendo,
            n = s.ui.Widget,
            ...
            r = n.extend({
                ...
                _user: function() {
                    this.options.user.id = ENV.extension;
                },
                getUser: function() {
                ...
                _view: function() {
                    ...
                    this.view = new s.chat.ChatView(a, n), this.view.bind("actionClick", (e) => {
                        t.trigger("actionClick", e), e.text ? t.postMessage(e.text) : this.scrollToBottom();
                    })
                },
                ...
                renderMessage: function(t, e, direction = 1) {
                    direction ? this.view.renderMessage(t, e) : this.view.preRenderMessage(t, e);
                },
                renderSuggestedActions: function(t, direction = 1) {
                    direction ? this.view.renderSuggestedActions(t) : this.view.preRenderSuggestedActions(t)
                },
                ...
                scrollToBottom: function() {
                    this.view ? this.view._scrollToBottom() : void(0);
                }
            });
        s.ui.plugin(r), i(!0, r, {
            styles: a
...
//# sourceMappingURL=kendo.mychat.min.js.map
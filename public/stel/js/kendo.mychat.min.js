...
! function(t, define) {
    ...
    return function(t, e) {
        var s, n, i, o, a = window.kendo,
            ...
            file = a.template('<div class="#=styles.message#" # if (typeof uid !== "undefined") { # id="#: uid #" # } #><time class="#=styles.messageTime#">#= kendo.toString(kendo.parseDate(timestamp), "dd/MM/yy HH:mm:ss") #</time><div class="#=styles.status#">#=status#</div><div class="#=styles.bubble#">#if(typeof url != "undefined"){#<a href="#:url#"><b>#if(typeof filename != "undefined"){##: filename ##}#</b></a>#}#</div></div>');
        a.chat = {
            Templates: {},
            Components: {}
        ...
        }, a.chat.registerTemplate("img", file), a.chat.registerTemplate("img", w), a.chat.registerTemplate("text", m), a.chat.registerTemplate("message", m), a.chat.registerTemplate("typing", f), a.chat.registerTemplate("suggestedAction", b), a.chat.registerTemplate("heroCard", y), a.chat.registerTemplate("application/vnd.microsoft.card.hero", y), a.chat.registerComponent = function(t, e) {

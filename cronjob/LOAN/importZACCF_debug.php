...
$inputFileName = "/data/upload_file/{$folder}/ZACCF_test.txt";
// echo $inputFileName;
// exit();
    ...
    if(!empty($temp)) {
        ...
        if($header) {
            foreach ($header as $index => $field) {
                ...
                $doc[$field] = mb_convert_encoding($doc[$field], 'ISO-8859-1', 'UTF-8');
            }
        }
        ...
        $mongo_db->insert($collection,$doc);

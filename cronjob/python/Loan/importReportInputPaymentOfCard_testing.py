...
try:
    ...
    test_collection = common.getSubUser(subUserType, 'Report_input_payment_of_card_test')
    ...
    month = today.month
    year = today.year
    fileName = 'test_gl_20191231' + '.dat'
    # fileName = 'gl_20200119' + '.dat'
    sep = ';'
        ...
        with open(importLogInfo['file_path'], 'r', newline='\n', encoding='ISO-8859-1') as fin:
            ...
            for idx, row in enumerate(csv_reader):
                ...
                if len(row) > 0:
                    ...
                    # try :
                    #     temp['account_number']
                    #     if temp['account_number'] == '0028100000049938':
                    #         pprint(temp)
                    #         mongodb.insert(test_collection, temp)
                    # except:
                    #     pprint('error field')
